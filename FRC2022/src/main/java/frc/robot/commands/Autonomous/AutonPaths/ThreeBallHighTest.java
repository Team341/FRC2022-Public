...
import frc.robot.commands.FloorIntake.AutoRunFloorIntakeOut;
...
import frc.robot.commands.FloorIntake.RunOnlyFloorIntake;
...
public class ThreeBallHighTest extends SequentialCommandGroup {
  /** Creates a new ThreeAllHigh. */
  public ThreeBallHighTest(Drivebase mDrivebase, FloorIntake floor, Tower tower, Shooter shooter) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        new FollowTrajectory(mDrivebase, AutoPaths.threeBallTest.get(0), "Part 1",
      ...
      new ParallelDeadlineGroup(
        ...
        new SequentialCommandGroup(
        new RunOnlyFloorIntakeOut(floor).withTimeout(0.3),
        new RunOnlyFloorIntake(floor)
        )
      ),
        new FollowTrajectory(mDrivebase, AutoPaths.threeBallTest.get(1), "Part 2",
        false).withTimeout(10.0),
