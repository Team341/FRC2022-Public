...
public class TwoBallHigh extends SequentialCommandGroup {
  /** Creates a new ThreeAllHigh. */
  public TwoBallHigh(Drivebase mDrivebase, FloorIntake floor, Tower tower, Shooter shooter) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        new FollowTrajectory(mDrivebase, AutoPaths.twoBall, "Part 1",
      ...
      new TeleopHeading(mDrivebase, DaisyMath.boundAngleNeg180to180Degrees(Constants.Auto.TWO_BALL_HIGH_START_ANGLE + 180.0)).withTimeout(10.0),
      new WaitCommand(0.5)
