...
public class ShooterRPMHigh extends CommandBase {
   ...
   */
  public ShooterRPMHigh(Shooter shooter, Tower tower, boolean enableLimelight,
  ...
  public ShooterRPMHigh(Shooter shooter, Tower tower, boolean enableLimelight,
    ...
    this(shooter, tower, enableLimelight, defaultRPM, end, 0.0);
  }
  ...
  public void execute() {
    ...
    if (Timer.getFPGATimestamp() - time < 0.3) {
      ...
      if (Timer.getFPGATimestamp() - time < 0.15) {
        mTower.runBackwards();
      }
    // if (Timer.getFPGATimestamp() - time < 0.15) {
    //   mTower.runBackwards();
